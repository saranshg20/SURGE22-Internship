 ...
 */
DataCallbackResult
StabilizedCallback::onAudioReady(AudioStream *oboeStream, void *audioData, int32_t numFrames, int offset) {
    ...
    DataCallbackResult result = mCallback->onAudioReady(oboeStream, audioData, numFrames, offset);
    Trace::endSection();
